...
function run() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const octokit = new rest_1.Octokit({ auth: `token ${githubToken}`, request: { fetch: node_fetch_1.default } });
        ...
        try {
            ...
            if (messageType === 'slack') {
                yield service.sendSlackMessage(token, slackChannel, context, commit);
            }
